<html>
    ...
    $query = mysqli_query($conn, "SELECT * FROM registro_admin WHERE usuario = '$usuario' AND contra = '$contra'");
    $nr = mysqli_num_rows($query);


    if($nr == 1)
    {
        header("Location: http://localhost/ProyectoRPG/PISAMKI/PanelAdmin.html");
    }
    else if($nr == 0)
